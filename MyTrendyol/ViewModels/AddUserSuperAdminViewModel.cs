...
{
    public class AddUserSuperAdminViewModel : ViewModelBase
    {
        ...
        public AddUserSuperAdminViewModel(INavigationService navigationService, TrendyolDbContext context)
        {
        ...
        public RelayCommand Register
        {
            get => new(async () =>
            {
                try
                {
                    ...
                    var newUser = _usersservice.UserRegister(Name, Surname, Login, Email, Password, Phone);
